      ...
      <div className="flex bg-white">
        ...
        <div className=" navup pb-8 flex">
            <ul className = "flex space-x-20  items-center mt-9  text-small font-">
              <Link className=" text-gray-500 hover:text-black hover:border-b-1 hover:border-gray-300 ml-64 hover:shadow-lg hover:bg-gray-100 transition-shadow duration-300 px-4 py-2 rounded-full" to="/Stays">Stays</Link>
